    ...
    while arc == True:
        if a.lives == 0:
            ...
            while spider.qlives != 0:
                choice = input(
                    "what attack would you like to use 1. Fire ball 100dmg -1 life 2. gold fist 50dmg -1/2 life: ")
                if choice == "devtools":
                ...
                if choice == "1":
                    if o != "on cooldown":
                        spider.health = spider.health - 100
                        ...
                        if a.health != 0:
                            ...
                            print(
                                f"Spider hsa done {damage} damage and you lost a life")
                            a.lives = a.lives - 1
                            a.health = 100
                        o = "on cooldown"
                    else:
            ...
            if spider.qlives == 0:
                print("Spider has died congrats player you have won! ")
                arc = False
    if arc == False:
